...
import '../../domain/use_cases/get_venues_use_case.dart';
...
class VenueBloc extends Bloc<VenueEvent, VenueState> {
  ...
  final Logger _logger = Logger('VenueBloc');
  ...
  Future<void> _onFetchVenues(
    ...
    try {
      ...
      _logger.info('Loaded ${venues.length} venues');
    } catch (e, stackTrace) {
      _logger.severe('Failed to fetch venues', e, stackTrace);
